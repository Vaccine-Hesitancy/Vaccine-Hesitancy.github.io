! function(t) {
    t.tablesort = function(e, s) {
        ...
        sort: function(e, s) {
            ...
            0 !== c.length && (null !== this.index && this.index !== e.index() ? (this.direction = "asc", this.index = e.index()) : this.direction = "asc" !== s && "desc" !== s ? "asc" === this.direction ? "desc" : "asc" : s, s = "asc" == this.direction ? 1 : -1, n.$table.trigger("tablesort:start", [n]), n.log("Sorting by " + this.index + " " + this.direction), n.$table.css("display"), setTimeout(function() {
        ...
        return this.each(function() {
            s = t(this), (i = s.data("tablesort")) && i.destroy(), s.data("tablesort", new t.tablesort(s, e))
        })
    }
